...
export default function Home() {
  ...
  const toggleActive = () => setIsActivated(!isActivated);
  ...
  return (
    ...
    <LeftSidebar isActivated={isActivated} toggleActive={toggleActive}/>
    <div className={`p-4 ${isActivated ? '' : 'ml-64'}`}>
        ...
        <div className="p-4 mb-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
        <h1 className="font-bold mb-4 text-xl">Bests Vaults</h1>
        <div className="flex flex-row">
